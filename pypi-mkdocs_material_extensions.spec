...
%prep
%setup -q -n mkdocs_material_extensions-1.3.1
cd %{_builddir}/mkdocs_material_extensions-1.3.1
pushd ..
cp -a mkdocs_material_extensions-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702069279
